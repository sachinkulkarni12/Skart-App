...
public class ArticleEndpiont {
	...
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public Response getArticleDetail() {
		List<Article> list = new ArrayList<>();
		list.add(new Article(10, "java", "language"));
		list.add(new Article(11, "dotnet", "language"));
		list.add(new Article(12, "php", "scripting"));
		return Response.ok(list).build();
	}
